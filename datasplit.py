...
result_interaction.write.parquet('hdfs:/user/pg1910/pub/goodreads/goodreads_interactions.parquet')
data_parquet = spark.read.parquet('hdfs:/user/pg1910/pub/goodreads/goodreads_interactions.parquet')
...
train.write.parquet('hdfs:/user/pg1910/pub/goodreads/training_sample.parquet')
val.write.parquet('hdfs:/user/pg1910/pub/goodreads/validation_sample.parquet')
test.write.parquet('hdfs:/user/pg1910/pub/goodreads/testing_sample.parquet')
