...
result_interaction =  queries.top_interaction10p(spark, 'hdfs:/user/bm106/pub/goodreads/goodreads_interactions.csv')

result_interaction.write.parquet('hdfs:/user/tb2517/pub/goodreads/goodreads_interactions_10p.parquet')
data_parquet = spark.read.parquet('hdfs:/user/tb2517/pub/goodreads/goodreads_interactions_10p.parquet')
...
train.write.parquet('hdfs:/user/tb2517/pub/goodreads/training_sample_10p.parquet')
val.write.parquet('hdfs:/user/tb2517/pub/goodreads/validation_sample_10p.parquet')
test.write.parquet('hdfs:/user/tb2517/pub/goodreads/testing_sample_10p.parquet')
