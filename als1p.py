...
df_training = spark.read.parquet('hdfs:/user/pg1910/pub/goodreads/training_sample_1p.parquet')
df_validation = spark.read.parquet('hdfs:/user/pg1910/pub/goodreads/testing_sample_1p.parquet')
df_test = spark.read.parquet('hdfs:/user/pg1910/pub/goodreads/testing_sample_1p.parquet')
...
user_recs.write.csv('hdfs:/user/pg1910/pub/goodreads/user_recs_1p.csv')

prediction_val = best_model.transform(df_validation)
# print(" Predictions for validation dataset: ------------------------------")
# prediction_val.show()
prediction_val.write.csv('hdfs:/user/pg1910/pub/goodreads/prediction_val_1p.csv')

prediction_test = best_model.transform(df_test)
# print(" Predictions for test dataset: ------------------------------")
# prediction_test.show()
prediction_test.write.csv('hdfs:/user/pg1910/pub/goodreads/prediction_test_1p.csv')
